...
<head>
    ...
    <title>La Manzanilla: Inventario Movimientos</title>
    <link rel="icon" href="../Imagenes/quesoMesa.png">
    <link rel="stylesheet" href="../css/bootstrapNav.css">
    <link rel="stylesheet" href="../css/inventarioMov.css">
...
<body>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="inventarioSald.php">Inventario saldos</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
    ...
    <div id="divContainer">
        <div id="divTitle">
            ...
            <a href="nuevoProducto.html"><button type="button" class="nuevoP">Nuevo registro</button></a>
        </div>
        <div id="divTable">
            <table cellspacing="0" cellpadding="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo "<a href='../Model/editar.php?idProducto=".$mostrar['idProducto']."'>Editar</a>";?>
                        </td>
                        <td>
                            <?php echo "<a href='../Model/eliminar.php?idProducto=".$mostrar['idProducto']."' onclick='return confirmar()'>Eliminar</a>";?>
                        </td>
                    </tr>
