...
<body>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="indexInventarioMov.php?c=inventarioMovimientos&a=index">Inventario movimeintos</a></li>
    ...
    <div id="divContainer">
        ...
        <div id="divTable">
            <form id="nuevo-producto" name="nuevo-producto" method="post" action="indexInventarioMov.php?c=inventarioMovimientos&a=guarda" autocomplete="off">
                ...
                <option class="select" value="select">Selecciona el ID del Producto</option>
                <?php
                    foreach($data["inventarioMovimientos"] as $dato) {
                        echo "<tr><option class='options' value='$dato[idProducto]'>$dato[idProducto] $dato[nombre]</option></tr>";
                    }  
                ?>
                </select>
                <p>Cantidad:</p>
                <input class="campo" type="text" name="cantidad" required>
